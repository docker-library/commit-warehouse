...
# if BONITA_HOME doesn't exists... get it !
if [ ! -d ${BONITA_PATH}/${BONITA_ARCHIVE_DIR}/bonita ]
then
...
license=`ls -trh ${BONITA_PATH}/*.lic 2>/dev/null|tail -n1`
if [ -z "$license" ]
then
...
cp $license ${BONITA_PATH}/${BONITA_ARCHIVE_DIR}/bonita/server/licenses
