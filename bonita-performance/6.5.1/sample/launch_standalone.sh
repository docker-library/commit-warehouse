...
#sleep 30
docker run --name=bonita-performance_h2 -h cloud -v /home/guillaume/git/docker/bonita-performance/6.5.x/sample/bonita:/opt/bonita/ -v /home/guillaume/git/docker/bonita-performance/6.5.x/sample/home:/opt/bonita_home/ -e JAVA_OPTS="-Xms128m -Xmx128m -XX:MaxPermSize=64m" -e "BENCH_ACTIVE=true" -d -p 8081:8080   bonita_65x_test
#sleep 60
