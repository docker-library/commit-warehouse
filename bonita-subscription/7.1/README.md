...
Retrieve the licence from the [customer portal](https://customer.bonitasoft.com) and place it to a directory on your host :	
    ...
    cp ~/Téléchargements/BonitaBPMSubscription-7.0-jeremy_Jacquier-roux-bonita-20150616-20151212.lic ~/Documents/Docker/Volumes/bonita-subscription
...
### Oracle
	...
	docker run --name bonita_oracle --link mydboracle:oracle -e DB_ADMIN_PASS=oracle -e DB_NAME=xe -h bonita -v ~/Documents/Docker/Volumes/bonita-subscription-7.1/:/opt/bonita_home/ -d -p 8080:8080 bonitasoft/bonita-subscription:7.1.5
