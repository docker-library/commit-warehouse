...
sleep 30
docker run --name=bonita-performance_psql -h cloud -v /home/guillaume/svn/cloud/docker/trunk/bonita-performance/6.5.x/sample/bonita:/opt/bonita/ -v /home/guillaume/svn/cloud/docker/trunk/bonita-performance/6.5.x/sample/home:/opt/bonita_home/ -e "BENCH_ACTIVE=true" -d -p 8081:8080  --link mydbpostgres:postgres bonita_65x_test
#sleep 60
