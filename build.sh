...
exit_with_usage() {
  ...
  echo "  $> ./$SCRIPT_NAME -a build_args -- bonita-subscription/7.5"
  echo "  $> ./$SCRIPT_NAME -a build_args -c -- bonita-subscription/7.5 --build-arg key1=value1 --build-arg key2=value2"
  echo ""
