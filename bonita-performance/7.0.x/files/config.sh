...
then
	...
	BUSINESS_DATA_HIBERNATE_DIALECT='postgres'
...
then
	...
	BUSINESS_DATA_HIBERNATE_DIALECT='mysql'
else
	DB_VENDOR='h2'
	BUSINESS_DATA_HIBERNATE_DIALECT='h2'
fi
...
cp ${BONITA_TPL}/bonita-tenant-sp-custom.properties ${BONITA_PATH}/${BONITA_ARCHIVE_DIR}/bonita/engine-server/conf/tenants/template/bonita-tenant-sp-custom.properties
